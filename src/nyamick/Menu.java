        ...
        do {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    System.out.println("Компания " + title + "удалена!");
                    break;
    ...
    private static void createCompany() {
        ...
        switch (choice) {
            case 1:
                ...
                title = scanner.nextLine();
                State.companies.add(new InsuranceCompany(title));
                System.out.println("Компания " + title + " добавлена!");
                return;
            case 2:
                System.out.print("Введите название компании: ");
                title = scanner.nextLine();
                State.companies.add(new ShipbuildingCompany(title));
                System.out.println("Компания " + title + " добавлена!");
            ...
            case 3:
                System.out.print("Введите название компании: ");
                title = scanner.nextLine();
                State.companies.add(new AircraftFactory(title));
                System.out.println("Компания " + title + " добавлена!");
